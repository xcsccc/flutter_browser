...
class SettingTopView extends StatefulWidget {
  ...
  const SettingTopView(this.custom, this.topTitle, {super.key});
...
class SettingTopState extends State<SettingTopView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(widget.topTitle,
                          style: const TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 16))
                    ],
                  )),
              Divider(
                  height: 1, thickness: 1.2, color: ThemeColors.divideColor),
              ...widget.custom
            ])));
  }
}
